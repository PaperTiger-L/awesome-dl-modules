...
HaLoAttention - Python Implementation
...
self.rel_height = nn.Parameter(torch.randn(height * 2 - 1, dim_head) *
scale)
self.rel_width = nn.Parameter(torch.randn(width * 2 - 1, dim_head) *
scale)
...
sim.masked_fill(_mask, max_neg_value)
