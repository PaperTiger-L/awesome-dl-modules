...
EfficientAdditiveAttnetion - Python Implementation

Paper: SwiftFormer: Efficient Additive Attention for Transformer-based Real-time Mobile VisionApplications
...
# 定义高效加性注意力模块
class EfficientAdditiveAttrnetion(nn.Module):
    """
...
if __name__ == '__main__':
    ...
    Model = EfficientAdditiveAttrnetion(in_dims=512, token_dim=512)
    out = Model(X)
