...
Cloattention - Python Implementation

Paper: Rethinking Local Perception in Lightweight Vision Transformer
...
def forward(self, x: torch.Tensor):
    ...
    continue
    res.append(self.high_fre_attention(x, self.qkvs[i], self.convs[i], self.act_blocks[i]))
