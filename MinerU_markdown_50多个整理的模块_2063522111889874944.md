...
class PositionAttentionModule(nn.Module):
    ...
    y=y.view(B,C,-1).permute(0,2,1)  # (B, C, H, W) --> (B,C,N)-->(B,N,C)
    N=H*W
...
freq_sel_method='top16'):
    ...
    # make the frequencies in different sizes are identical to a $7 \times$ frequency space
    # eg,(2.2) in $14 \times$ 14 is identical to (1.1) in $7 \times$ frequency space
